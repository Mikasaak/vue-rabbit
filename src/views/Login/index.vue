...
const rules = ref({
  ...
  agree: [
    { validator: checkIsAgree, trigger: 'change' }
  ]
          ...
          <div class="form">
            <el-form ref="formRef" label-position="right" label-width="60px" status-icon :model="form" :rules="rules">
              <el-form-item  prop="account" label="账户">
                <el-input name="account" autocomplete="on" v-model.trim="form.account"/>
              </el-form-item>
              <el-form-item prop="password" label="密码">
                <el-input name="password" type="password" autocomplete="on" v-model.trim="form.password"/>
              </el-form-item>
